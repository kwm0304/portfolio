...
import { BsSunFill, BsMoonFill, BsTelephoneFill, BsFillEnvelope } from 'react-icons/bs'
  ...
  return (
    ...
    <div className="grid grid-cols-3 items-center text-gray-600 p-0 m-0 dark:bg-gray-800 pt-4 xl:pb-12 xs:pb-2">
      ...
      <div className="COL2 grid grid-cols-1 justify-content-center  text-center">
        <h1 className={theme === 'dark' ? 'neon' : 'xl:text-6xl lg:text-5xl md:text-4xl heading font-sans xs:text-lg'}>Kenan McKenzie</h1>
      </div>
      ...
      <div className="flex justify-end xl:gap-4 xl:mr-8 xs:mr-4 xs:gap-2  dark:text-cyan-400  ">
        <a href={Resume} download='Resume.pdf'>
          <FaFileDownload className='dark:hover:text-white hover:text-gray-700 xl:text-xl lg:text-3xl  xs:text-xl hover:scale-110 '/>
        </a>
        ...
        <a href='mailto:mckenzie.kenan.90@gmail.com' target='_blank' rel='noReferrer'><BsFillEnvelope className="xs:text-2xl xl:text-3xl dark:text-cyan-400 dark:hover:text-white hover:scale-110 text-gray-600 hover:text-gray-700"/></a>
